...
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step00
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step01
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step02
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step03
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step04
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step05
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step06
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step07
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step08
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step09
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step10
import GNC.Applications.ApproachGate.Data.RTNSTT2Time6Step11
...
namespace GNC.ApproachGate.RTNSTT2Time6
...
theorem valid (j : ℕ) (hj : j < 12) :
    (steps j).Valid polynomial (field .rtn (command j)) := by
  interval_cases j
...
def predictionPositionBound : ℚ := (113949/100000000)
...
theorem every_motion {θ : ℝ} (hθ : |θ| ≤ Real.pi/180) (x : Motion .rtn command θ) :
  ...
  have he := motion_enclosed polynomial steps .rtn command valid joins
    (fun j hj => (numbers j hj).1) (fun j hj => (numbers j hj).2.1) θ ha (initial_bound ha) x
  apply terminal_norms polynomial (steps 11) (field .rtn (command 11)) (valid 11 (by norm_num))
