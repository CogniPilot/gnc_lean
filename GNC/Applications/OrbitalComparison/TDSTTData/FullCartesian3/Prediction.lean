import GNC.Applications.OrbitalComparison.TDSTTData.FullCartesian3.Envelope
import GNC.Applications.OrbitalComparison.TDSTTData.FullCartesian3.Kinematics
import GNC.Dynamics.CandidateOrbitExistence

/-! Full inverse-square, all-time certificate for the delivered Cartesian
full cubic polynomial query. Its velocity is the fitted tensor output, so
