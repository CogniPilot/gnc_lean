...
def residualPart2_0 : Coefficients := []

theorem residualPart2_0_checked : zero (subtract
    (add (basePieces2 0) (scale modelInput.K
      (degreeProduct 0 cubeDeviation coupledPartition2))) residualPart2_0) := by
  decide +kernel
