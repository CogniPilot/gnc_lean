...
def residualPart1_0 : Coefficients := []

theorem residualPart1_0_checked : zero (subtract
    (add (basePieces1 0) (scale modelInput.K
      (degreeProduct 0 cubeDeviation coupledPartition1))) residualPart1_0) := by
  decide +kernel
