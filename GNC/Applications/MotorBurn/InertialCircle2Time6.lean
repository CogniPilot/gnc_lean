...
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step00
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step01
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step02
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step03
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step04
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step05
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step06
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step07
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step08
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step09
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step10
import GNC.Applications.MotorBurn.Data.InertialCircle2Time6Step11
...
namespace GNC.MotorBurn.InertialCircle2Time6
...
def on : ℕ → ℚ
  | 0 => Data.InertialCircle2Time6Step00.on
  | 1 => Data.InertialCircle2Time6Step01.on
  | 2 => Data.InertialCircle2Time6Step02.on
  | 3 => Data.InertialCircle2Time6Step03.on
  | 4 => Data.InertialCircle2Time6Step04.on
  | 5 => Data.InertialCircle2Time6Step05.on
  | 6 => Data.InertialCircle2Time6Step06.on
  | 7 => Data.InertialCircle2Time6Step07.on
  | 8 => Data.InertialCircle2Time6Step08.on
  | 9 => Data.InertialCircle2Time6Step09.on
  | 10 => Data.InertialCircle2Time6Step10.on
  | _ => Data.InertialCircle2Time6Step11.on
def input : ℕ → Fin 13 → ℚ
  | 0 => Data.InertialCircle2Time6Step00.inputBound
  | 1 => Data.InertialCircle2Time6Step01.inputBound
  | 2 => Data.InertialCircle2Time6Step02.inputBound
  | 3 => Data.InertialCircle2Time6Step03.inputBound
  | 4 => Data.InertialCircle2Time6Step04.inputBound
  | 5 => Data.InertialCircle2Time6Step05.inputBound
  | 6 => Data.InertialCircle2Time6Step06.inputBound
  | 7 => Data.InertialCircle2Time6Step07.inputBound
  | 8 => Data.InertialCircle2Time6Step08.inputBound
  | 9 => Data.InertialCircle2Time6Step09.inputBound
  | 10 => Data.InertialCircle2Time6Step10.inputBound
  | _ => Data.InertialCircle2Time6Step11.inputBound
theorem valid (j : ℕ) (hj : j < 12) :
    (steps j).Valid circle (field .inertial (command j) (on j)) := by
  interval_cases j
...
theorem input_budget (j : ℕ) (hj : j < 12) (i : Fin 13) :
    circle.bound (residual circle (field .inertial (command j) (on j)) (steps j).coefficients i)
      (steps j).duration (steps j).angle+input j i ≤ (steps j).defect i := by
  interval_cases j
  · exact Data.InertialCircle2Time6Step00.input_budget i
  · exact Data.InertialCircle2Time6Step01.input_budget i
  · exact Data.InertialCircle2Time6Step02.input_budget i
  · exact Data.InertialCircle2Time6Step03.input_budget i
  · exact Data.InertialCircle2Time6Step04.input_budget i
  · exact Data.InertialCircle2Time6Step05.input_budget i
  · exact Data.InertialCircle2Time6Step06.input_budget i
  · exact Data.InertialCircle2Time6Step07.input_budget i
  · exact Data.InertialCircle2Time6Step08.input_budget i
  · exact Data.InertialCircle2Time6Step09.input_budget i
  · exact Data.InertialCircle2Time6Step10.input_budget i
  · exact Data.InertialCircle2Time6Step11.input_budget i
...
theorem every_motion_enclosed {θ : ℝ} (hθ : |θ| ≤ Real.pi/180)
  ...
  exact motion_enclosed circle steps .inertial command on input valid joins
...
theorem every_motion_mass_ratio {θ : ℝ} (hθ : |θ| ≤ Real.pi/180)
  ...
  have hr := region_of_enclosure circle (steps j) (field .inertial (command j) (on j)) (valid j hj)
...
theorem exists_physical_enclosed {θ : ℝ} (hθ : |θ| ≤ Real.pi/180)
    ...
    ∃ x : Motion .inertial command on w θ, x.Physical ∧
      ∀ j < 12, ∀ t ∈ Icc (0 : ℝ) (stepDuration : ℝ), ∀ i,
        |x.state j t i-curve circle (steps j).coefficients θ t i| < ((steps j).error i : ℝ) := by
  have ha := ApproachGate.one_degree_enclosed hθ
  obtain ⟨x, he⟩ := exists_motion circle steps .inertial command on input valid joins
    (fun j hj => (numbers j hj).1) (fun j hj => (numbers j hj).2.1)
  ...
  have hr (j : ℕ) (hj : j < 12) (t : ℝ) (ht : t ∈ Icc (0 : ℝ) (stepDuration : ℝ)) (i : Fin 13) :
    ...
    region_of_enclosure circle (steps j) (field .inertial (command j) (on j)) (valid j hj)
...
end GNC.MotorBurn.InertialCircle2Time6
